// Generated by dart2js (NullSafetyMode.sound, csp, deferred-serialization, intern-composite-values), the Dart to JavaScript compiler version: 3.1.0-549219276.
...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    _EventStreamSubscription$(_target, _eventType, onData, _useCapture, $T) {
      ...
      if (t1 != null && true)
        B.Window_methods.addEventListener$3(_target, _eventType, t1, false);
    ...
    main() {
      var t1 = window;
      t1.toString;
      A._EventStreamSubscription$(t1, "message", type$.nullable_void_Function_MessageEvent._as(new A.main_closure()), false, type$.MessageEvent);
    },
  ...
  A.main_closure.prototype = {
    call$1(message) {
      var t1 = type$.MessageEvent._as(message).data,
        t2 = new A._AcceptStructuredCloneDart2Js([], []);
      t2.mustCopy = true;
      A.printString("message " + A.S(t2.walk$1(t1)));
    },
    $signature: 14
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A._Future__chainForeignFuture_closure0, A.MapBase_mapToString_closure, A._AcceptStructuredClone_walk_closure]);
...
//# sourceMappingURL=calculator.dart.js.map
